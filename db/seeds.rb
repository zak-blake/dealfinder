...
user_list = [
  [ "sandbar@gmail.com",     "Sandbar",              "password", 0],
  [ "seven@gmail.com",      "Seven",                "password", 0],
  [ "beachclub@gmail.com",  "Beach Club",           "password", 0],
  [ "admin@gmail.com",      "Matrix Bar and Club",  "password", 0],
  [ "donkey@gmail.com",     "Donkey Bar and Grill", "password", 0],
...
event_list = [
  ...
  ["Day Drinking", "10:00am", "04:00pm", "SSynth aesthetic seitan, fixie vegan cray kickstarter meggings listicle sriracha enamel pin pour-over before they sold out bicycle rights. Unicorn VHS listicle humblebrag la croix try-hard normcore. Pabst craft beer distillery single-origin coffee authentic wolf."],
...
user_list.each do |email, name, password, user_context|
